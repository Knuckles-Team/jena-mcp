...
name: jena-starter
description: >-
  Jena API + MCP Server + A2A Server Use when working with Jena via this package's MCP
...
Starter skill for the **Jena** package. Use the `mcp-client` universal skill
